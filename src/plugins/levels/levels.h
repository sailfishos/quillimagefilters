...
#ifndef __QUILL_FILTERS_LEVELS_H__
#define __QUILL_FILTERS_LEVELS_H__

#include "quillimagefilterimplementation.h"

class LevelsPrivate;

class Levels : public QuillImageFilterImplementation
{
public:
    Levels();
    ~Levels();
    ...
    virtual const QString name() const { return QuillImageFilter::Name_Levels; }

private:
    int level(int min, int max, int i) const;
    bool setIntFromVariant(int *value, const QVariant &variant) const;
