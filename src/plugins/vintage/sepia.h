...
#ifndef __QUILL_FILTERS_SEPIA_H__
#define __QUILL_FILTERS_SEPIA_H__

#include "quillimagefilterimplementation.h"

class SepiaPrivate;

class Sepia : public QuillImageFilterImplementation
{
public:
    Sepia();
    ~Sepia();
    ...
    virtual const QString name() const { return QuillImageFilter::Name_Sepia; }
