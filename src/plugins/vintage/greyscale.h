...
#ifndef __QUILL_FILTERS_GREYSCALE_H__
#define __QUILL_FILTERS_GREYSCALE_H__

#include "quillimagefilterimplementation.h"

class GreyscalePrivate;

class Greyscale : public QuillImageFilterImplementation
{
public:
    Greyscale();
    ~Greyscale();
    ...
    virtual const QString name() const { return QuillImageFilter::Name_Greyscale; }

private:
    GreyscalePrivate *priv;
};
