...
#ifndef __QUILL_FILTERS_CROSSPROCESSING_H__
#define __QUILL_FILTERS_CROSSPROCESSING_H__

#include "quillimagefilterimplementation.h"

class CrossProcessingPrivate;

class CrossProcessing : public QuillImageFilterImplementation
{
public:
    CrossProcessing();
    ~CrossProcessing();
    ...
    virtual const QString name() const { return QuillImageFilter::Name_CrossProcessing; }

private:
    CrossProcessingPrivate *priv;
};
