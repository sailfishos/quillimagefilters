...
#ifndef _VINTAGEPLUGIN_H_
#define _VINTAGEPLUGIN_H_

#include "quillimagefilter.h"
#include "quillimagefilterinterface.h"

class VintagePlugin : public QObject,
    public QuillImageFilterInterface
{
    Q_OBJECT
#if QT_VERSION >= QT_VERSION_CHECK(5, 0, 0)
    Q_PLUGIN_METADATA(IID QUILL_IMAGE_FILTER_INTERFACE_ID FILE "vintage.json")
#endif
