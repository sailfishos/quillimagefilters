...
#ifndef __QUILL_FILTERS_FLIP_H__
#define __QUILL_FILTERS_FLIP_H__

#include "quillimagefilterimplementation.h"

class FlipPrivate;

class Flip : public QuillImageFilterImplementation
{
public:
    Flip();
    ~Flip();
    ...
    virtual const QString name() const { return QuillImageFilter::Name_Flip; }
private:
