...
#ifndef _FLIPPLUGIN_H_
#define _FLIPPLUGIN_H_

#include "quillimagefilter.h"
#include "quillimagefilterinterface.h"
#include "flip.h"

class FlipPlugin : public QObject,
    public QuillImageFilterInterface
{
    Q_OBJECT
#if QT_VERSION >= QT_VERSION_CHECK(5, 0, 0)
    Q_PLUGIN_METADATA(IID QUILL_IMAGE_FILTER_INTERFACE_ID FILE "flip.json")
#endif
