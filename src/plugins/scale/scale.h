...
/*!
  ...
  \brief A filter for scaling images.
...
#ifndef __QUILL_FILTERS_SCALE_H__
#define __QUILL_FILTERS_SCALE_H__

#include "quillimagefilterimplementation.h"

class ScalePrivate;

class Scale : public QuillImageFilterImplementation
{
public:
    Scale();
    ~Scale();
    ...
    virtual const QString name() const { return QuillImageFilter::Name_Scale; }
