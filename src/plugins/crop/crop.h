...
/*!
  ...
  \brief A filter for cropping images.
...
#ifndef __QUILL_FILTERS_CROP_H__
#define __QUILL_FILTERS_CROP_H__

#include "quillimagefilterimplementation.h"

class CropPrivate;

class Crop : public QuillImageFilterImplementation
{
public:
    Crop();
    ~Crop();
    ...
    virtual const QString name() const { return QuillImageFilter::Name_Crop; }
