...
#ifndef _CROPPLUGIN_H_
#define _CROPPLUGIN_H_

#include "quillimagefilter.h"
#include "quillimagefilterinterface.h"
#include "crop.h"

class CropPlugin : public QObject,
    public QuillImageFilterInterface
{
    Q_OBJECT
#if QT_VERSION >= QT_VERSION_CHECK(5, 0, 0)
    Q_PLUGIN_METADATA(IID QUILL_IMAGE_FILTER_INTERFACE_ID FILE "crop.json")
#endif
